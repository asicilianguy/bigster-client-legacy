...
import { ConsulenteScopeBanner } from "@/components/shared/ConsulenteScopeBanner";
import { UserRole } from "@/types/user";

// Test BigsTer è accessibile a HR, consulenti e ruoli con accesso alto
const ALLOWED_ROLES = [
  UserRole.CEO,
...
function TestBigsterPageContent() {
  ...
  return (
    <div className="min-h-screen bg-bigster-background">
      {/* Banner scope consulente — visibile solo ai consulenti */}
      <ConsulenteScopeBanner />
